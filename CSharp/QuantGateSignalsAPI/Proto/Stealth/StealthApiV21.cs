#pragma warning disable CA1825, IDE0041, IDE0044, IDE0060, IDE0079, IDE0090, IDE0300, IDE0301, CS8981, IDE0028
#nullable disable
...
namespace QuantGate.API.Signals.Proto.Stealth {
    ...
    static StealthApiV21Reflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::QuantGate.API.Signals.Proto.Stealth.InstrumentType), typeof(global::QuantGate.API.Signals.Proto.Stealth.PutOrCall), typeof(global::QuantGate.API.Signals.Proto.Stealth.StrategySignal), typeof(global::QuantGate.API.Signals.Proto.Stealth.GaugeSignal), }, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::QuantGate.API.Signals.Proto.Stealth.TriggerUpdate), global::QuantGate.API.Signals.Proto.Stealth.TriggerUpdate.Parser, new[]{ "Timestamp", "Bias", "Perception", "Sentiment", "Commitment", "EquilibriumPrice", "GapSize", "LastPrice", "IsDirty", "PriceConviction", "Confidence" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::QuantGate.API.Signals.Proto.Stealth.PriceConvictionUpdate), global::QuantGate.API.Signals.Proto.Stealth.PriceConvictionUpdate.Parser, new[]{ "Timestamp", "Conviction", "IsDirty" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::QuantGate.API.Signals.Proto.Stealth.StrategyUpdate), global::QuantGate.API.Signals.Proto.Stealth.StrategyUpdate.Parser, new[]{ "Timestamp", "EntryProgress", "ExitProgress", "Signal", "PerceptionLevel", "PerceptionSignal", "CommitmentLevel", "CommitmentSignal", "SentimentSignal", "EquilibriumSignal", "SentimentLevel", "EquilibriumLevel", "HighQuality" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::QuantGate.API.Signals.Proto.Stealth.PriceArrayUpdate), global::QuantGate.API.Signals.Proto.Stealth.PriceArrayUpdate.Parser, new[]{ "Timestamp", "Values", "IsDirty" }, null, null, null),
  ...
  internal sealed partial class TriggerUpdate : pb::IMessage<TriggerUpdate> {
    ...
    public TriggerUpdate(TriggerUpdate other) : this() {
      ...
      lastPrice_ = other.lastPrice_;
      isDirty_ = other.isDirty_;
      priceConviction_ = other.priceConviction_;
    ...
    /// <summary>Field number for the "price_conviction" field.</summary>
    public const int PriceConvictionFieldNumber = 10;
    private float priceConviction_;
    /// <summary>
    /// Raw, direction-agnostic price-conviction value (unbounded).
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public float PriceConviction {
      get { return priceConviction_; }
      set {
        priceConviction_ = value;
      }
    }
    ...
    public bool Equals(TriggerUpdate other) {
      ...
      if (LastPrice != other.LastPrice) return false;
      if (IsDirty != other.IsDirty) return false;
      if (PriceConviction != other.PriceConviction) return false;
    ...
    public override int GetHashCode() {
      ...
      if (LastPrice != 0UL) hash ^= LastPrice.GetHashCode();
      if (IsDirty != false) hash ^= IsDirty.GetHashCode();
      if (PriceConviction != 0F) hash ^= PriceConviction.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (PriceConviction != 0F) {
        output.WriteRawTag(85);
        output.WriteFloat(PriceConviction);
      }
      if (Confidence != 0F) {
    ...
    public void MergeFrom(TriggerUpdate other) {
      ...
      if (other.PriceConviction != 0F) {
        PriceConviction = other.PriceConviction;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 85: {
            PriceConviction = input.ReadFloat();
            break;
          }
          case 93: {
  ...
  /// <summary>
  /// PriceConvictionUpdate represents a new price-conviction subscription update -- for
  /// subscribing to the PriceConviction calculator on its own, independent of Trigger.
  /// Conviction is raw and direction-agnostic (not compressed/bounded like most gauge
  /// values in this file); Confidence is Trigger-only, since it also needs Perception/
  /// Commitment/Equilibrium/Sentiment, which this calculator doesn't have on its own. 
  /// </summary>
  internal sealed partial class PriceConvictionUpdate : pb::IMessage<PriceConvictionUpdate> {
    private static readonly pb::MessageParser<PriceConvictionUpdate> _parser = new pb::MessageParser<PriceConvictionUpdate>(() => new PriceConvictionUpdate());
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<PriceConvictionUpdate> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public PriceConvictionUpdate(PriceConvictionUpdate other) : this() {
      timestamp_ = other.timestamp_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public PriceConvictionUpdate Clone() {
      return new PriceConvictionUpdate(this);
    }
    ...
    public const int ConvictionFieldNumber = 2;
    private float conviction_;
    /// <summary>
    /// The raw price-conviction value.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as PriceConvictionUpdate);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(PriceConvictionUpdate other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Timestamp != 0UL) hash ^= Timestamp.GetHashCode();
      if (Conviction != 0F) hash ^= Conviction.GetHashCode();
      if (IsDirty != false) hash ^= IsDirty.GetHashCode();
      return hash;
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(PriceConvictionUpdate other) {
      if (other == null) {
        return;
      }
      if (other.Timestamp != 0UL) {
  ...
  internal sealed partial class StrategyUpdate : pb::IMessage<StrategyUpdate> {
    ...
    public StrategyUpdate(StrategyUpdate other) : this() {
      ...
      highQuality_ = other.highQuality_;
    }
    ...
    /// <summary>Field number for the "high_quality" field.</summary>
    public const int HighQualityFieldNumber = 13;
    private bool highQuality_;
    /// <summary>
    /// Is this update for a high-quality symbol (if false, shouldn't be listed in top symbols)?
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HighQuality {
      get { return highQuality_; }
      set {
        highQuality_ = value;
      }
    }
    ...
    public bool Equals(StrategyUpdate other) {
      ...
      if (HighQuality != other.HighQuality) return false;
      return true;
    }
    ...
    public override int GetHashCode() {
      ...
      if (HighQuality != false) hash ^= HighQuality.GetHashCode();
      return hash;
    }
  ...
  /// <summary>
  /// PriceArrayUpdate represents a new subscription update for a gauge that returns multiple
  /// price results (such as SMA/EMA) that are keyed to a list of periods that are originally 
  /// sent when the subscription is set up.
  /// All prices are converted to long values, empty values will be decoded as NaN. 
  /// </summary>
  internal sealed partial class PriceArrayUpdate : pb::IMessage<PriceArrayUpdate> {
    private static readonly pb::MessageParser<PriceArrayUpdate> _parser = new pb::MessageParser<PriceArrayUpdate>(() => new PriceArrayUpdate());
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<PriceArrayUpdate> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public PriceArrayUpdate(PriceArrayUpdate other) : this() {
      timestamp_ = other.timestamp_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public PriceArrayUpdate Clone() {
      return new PriceArrayUpdate(this);
    }
    ...
    /// <summary>
    /// Array of price updates by period index.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as PriceArrayUpdate);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(PriceArrayUpdate other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(PriceArrayUpdate other) {
      if (other == null) {
        return;
      }
      if (other.Timestamp != 0UL) {
