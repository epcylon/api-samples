...
internal class EquilibriumSubscription(APIClient client, EventHandler<EquilibriumEventArgs> handler,
                                       string streamID, string symbol, string compression,
                                       bool receipt = false, uint throttleRate = 0, object reference = null) :
    GaugeSubscriptionBase<EquilibriumUpdate, EquilibriumEventArgs>(
        client, EquilibriumUpdate.Parser, handler, SubscriptionPath.GaugeEquilibrium,
